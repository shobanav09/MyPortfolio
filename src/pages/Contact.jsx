...
export const Contact = () => {
  ...
  return (
    <div className=' mx-auto mt-[10px] relative mb-[120px]'>
      <div className='text-center m-10 font-bold font-heading text-3xl max-[450px]:text-xl' data-aos='zoom-out'>📩 Let's Connect!</div>

      {successMessage && (
        <div className='text-center text-green-500 text-xl font-bold absolute top-0 right-10  bg-[#fffefe] px-3 py-2 rounded-[8px]'>
          Mail sent successfully!
        </div>
      )}

      <form ref={form} onSubmit={sendEmail}  data-aos='zoom-out'>
        <div className='flex gap-12 justify-center max-[450px]:gap-2'>
          <div className='flex flex-col gap-12 '>
            <label className='font-heading font-bold text-xl max-[450px]:text-[16px]'>Name:</label>
            <label className='font-heading font-bold text-xl max-[450px]:text-[16px]'>Email:</label>
            <label className='font-heading font-bold text-xl max-[450px]:text-[16px]'>Message:</label>
          </div>
